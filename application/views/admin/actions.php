				...
				<div class="tabs">
					...
					<div class="tab">
						...
						<div id="divMap" style="width:900px;height:350px;border:0px;">
							...
							<a href="javascript:void(0)" class="btn_clear" style="float:right;margin-top:350px;padding:25px;"><?php echo strtoupper(Kohana::lang('ui_main.clear_map'));?></a>
						</div>
						...
						<div id="actions_qualifier_section">
							...
							<div class="tab_form_item" id="action_form_trigger">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo Kohana::lang("tooltips.actions.trigger"); ?>"><?php echo Kohana::lang('ui_admin.trigger'); ?>:</a></h4>
						...
						<div id="actions_qualifier_section" style="padding-top:10px;">
							...
							<div class="tab_form_item" id="action_form_user" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.user")); ?>"><?php echo Kohana::lang('ui_admin.user'); ?>:</a></h4>
							...
							<div class="tab_form_item" id="action_form_location" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.location")); ?>"><?php echo Kohana::lang('ui_main.location'); ?>:</a></h4>
							...
							<div class="tab_form_item" id="action_form_keyword" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.keywords")); ?>"><?php echo Kohana::lang('ui_admin.keywords'); ?>:</a></h4>
								<?php echo form::input('action_keyword',''); ?>
							</div>

							<div class="tab_form_item" id="action_form_category" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.category")); ?>"><?php echo Kohana::lang('ui_main.category'); ?>:</a></h4>
								<?php
							...
							<div class="tab_form_item" id="action_form_on_specific_count" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.on_specific_count")); ?>"><?php echo Kohana::lang('ui_admin.on_specific_count');?>:</a></h4>
							...
							<div class="tab_form_item" id="action_form_days_of_the_week" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.days_of_the_week")); ?>"><?php echo Kohana::lang('ui_admin.days_of_the_week');?>:</a></h4>
								<?php
							...
							<div class="tab_form_item" id="action_form_between_times" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.between_times")); ?>"><?php echo Kohana::lang('ui_admin.between_times');?>:</a></h4>
								<?php
									$hours = range(0,24);
							...
							<div class="tab_form_item" id="action_form_specific_days" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.specific_days")); ?>"><?php echo Kohana::lang('ui_admin.specific_days');?>:</a></h4>
						...
						<div id="actions_response_section" style="padding-top:10px;">
							...
							<div class="tab_form_item" id="action_form_response" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.response")); ?>"><?php echo Kohana::lang('ui_admin.response'); ?>:</a></h4>
								<?php
							...
							<div class="tab_form_item" id="action_form_email_send_address" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.send_to")); ?>"><?php echo Kohana::lang('ui_admin.send_to');?>:</a></h4>
							...
							<div class="tab_form_item" id="action_form_email_subject" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.email_subject")); ?>"><?php echo Kohana::lang('ui_admin.subject');?>:</a></h4>
								<?php echo form::input('action_email_subject',''); ?>
							</div>

							<div class="tab_form_item" id="action_form_email_body" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.email_body")); ?>"><?php echo Kohana::lang('ui_admin.body');?>:</a></h4>
								<?php echo form::textarea('action_email_body',''); ?>
							</div>

							<div class="tab_form_item" id="action_form_add_category" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.add_to_category")); ?>"><?php echo Kohana::lang('ui_admin.add_to_category'); ?>:</a></h4>
								<?php
									// categories, selected_categories, form field name, number of columns
							...
							<div class="tab_form_item" id="action_form_verify" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.verify")); ?>"><?php echo Kohana::lang('ui_admin.mark_as');?>:</a></h4>
							...
							<div class="tab_form_item" id="action_form_badge" style="margin-right:75px;">
								<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo htmlspecialchars(Kohana::lang("tooltips.actions.assign_badge")); ?>"><?php echo Kohana::lang('ui_admin.assign_badge'); ?>:</a></h4>
								<?php
