			...
			<div class="bg">
				...
				<div class="report-form">
					...
					<div class="sms_holder">
						...
						<div class="row">
							<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo Kohana::lang("tooltips.settings_server_username"); ?>"><?php echo Kohana::lang('ui_main.email_server_username');?></a></h4>
						...
						<div class="row">
							<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo Kohana::lang("tooltips.settings_server_password"); ?>"><?php echo Kohana::lang('ui_main.email_server_password');?></a></h4>
						...
						<div class="row">
							<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo Kohana::lang("tooltips.settings_server_port"); ?>"><?php echo Kohana::lang('ui_main.email_server_port');?></a></h4>
						...
						<div class="row">
							<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo Kohana::lang("tooltips.settings_server_host"); ?>"><?php echo Kohana::lang('ui_main.email_server_host');?></a></h4>
						...
						<div class="row">
							<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo Kohana::lang("tooltips.settings_server_type"); ?>"><?php echo Kohana::lang('ui_main.email_server_type');?></a></h4>
						...
						<div class="row">
							<h4><a href="javascript:void(0)" class="tooltip" title="<?php echo Kohana::lang("tooltips.settings_server_ssl_support"); ?>"><?php echo Kohana::lang('ui_main.email_server_ssl_support');?></a></h4>
