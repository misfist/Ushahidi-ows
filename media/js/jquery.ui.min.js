...
d("<div></div>");this.range.appendTo(this.element).addClass("ui-slider-range");if(k.range=="min"||k.range=="max")this.range.addClass("ui-slider-range-"+k.range);this.range.addClass("ui-widget-header")}d(".ui-slider-handle",this.element).length==0&&d('<a href="javascript:void(0)"></a>').appendTo(this.element).addClass("ui-slider-handle");if(k.values&&k.values.length)for(;d(".ui-slider-handle",this.element).length<k.values.length;)d('<a href="javascript:void(0)"></a>').appendTo(this.element).addClass("ui-slider-handle");this.handles=
